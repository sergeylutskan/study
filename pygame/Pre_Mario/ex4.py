...
pygame.init()
pygame.key.set_repeat(200, 70) #pygame.key.set_repeat(a, b) a - задержка перед первым дублированием, b - задержка между остальными дублированиями
...
parser.add_argument('level', nargs='?') #добавляем аргумент
...
if args.level:
    try:
        player, level_x, level_y = generate_level(load_level(args.level))
